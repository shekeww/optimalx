...
| Hero poster (frame 4) | Planned as you asked on 2026-09-25, on the Arabic home only (its text is Arabic); the carousel with the three new frames is still being built. Its baked-in lines "طاقة أعلى", "بناء عضلي" and "تعافي أسرع" are outcome promises the claims rules reject ("أسرع" is on the banned list), and the theme cannot gate text inside an image | A version with the headline and the products but without the benefit row, or keep it as your own call |
