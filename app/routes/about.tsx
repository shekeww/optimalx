...
/**
 * /about (P0 stub). B5 owns this file and builds the about page here
 * (DIRECTION 6.15). Custom routes sit under `{-$locale}` through app/routes.ts,
 * so this serves at /ar/about; the engine gives it no RouteId and no body
...
function AboutStub() {
  ...
  return (
    <section aria-busy="true">
      ...
      {import.meta.env.DEV && <p>TODO B5: about page</p>}
    </section>
  );
}
